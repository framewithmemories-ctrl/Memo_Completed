...
def _current_recovery_secret() -> str:
    # Read at request time so an updated Render environment value is never
    # accidentally shadowed by a value captured during module import.
